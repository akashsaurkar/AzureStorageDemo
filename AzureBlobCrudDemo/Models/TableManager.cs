...
namespace AzureBlobCrudDemo.Models
{
    public class TableManager
    {
        ...
        public TableManager(string _CloudTableName)
        {
            ...
            try
            {
                string ConnectionString = "DefaultEndpointsProtocol=https;AccountName=demorgdiag378;AccountKey=zMM/LZWtqJhOYuVNLnnwE79q8Xj39D356tgdzGU7h5KQ6wcxpC85LtpXAX4ooHUZhhyn7/6fuLSg3/lwFlbs8Q==;EndpointSuffix=core.windows.net";
