...
namespace AzureBlobCrudDemo.Models
{
    public class BlobManager
    {
        ...
        public BlobManager(string ContainerName)
        {
            ...
            try
            {
                ...
                string ConnectionString = "DefaultEndpointsProtocol=https;AccountName=demostorageaccount91;AccountKey=UqtwTSRVl+hS16dC1RD0RW0z5eFACp+GeVqmmyui94fftlGjnWG9ACSOd6+dpPhXI7fwQ+s4aVW5m+A6lNlAIw==;EndpointSuffix=core.windows.net";
